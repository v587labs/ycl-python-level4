...
一个面向老师上课的静态互动课件。当前版本聚焦 YCL Python 四级主线，包含 30 个课时：2 节序章、12 节四级主线课、16 节拓展挑战课，支持教师投屏模式、学生练习模式、本地进度、JSON 导入导出，以及浏览器内 Python 判题。
...
- 课时 0-1 为序章，课时 2-13 为四级主线，课时 14-29 为拓展挑战，不作为四级必学范围。
