...
const lesson01 = {
  ...
  teacher: {
    ...
    ageAdaptation: {
      target: "7-8岁，一二年级，已经会在IDLE或网页编辑器里运行print",
      pace: "先复习IDLE里运行print，再用实物盒子演示变量，最后加入input",
    ...
    lessonFlow: [
      {
        time: "0-5分钟",
        phase: "复习上一课：代码已经能跑起来",
        teacher: "先让孩子回忆：打开IDLE、新建文件、保存.py、按F5运行。再齐读 print(\"Hello\")，问：现在电脑会说固定的话了，如果想让它记住你的名字，只会说话够不够？",
        student: "回答已经会运行print，但print只能显示固定文字，还不能保存名字。"
      },
      {
        time: "5-12分钟",
    ...
    teacherScript: [
      {
        when: "开场复习",
        title: "从编辑器接到变量",
        say: "上节课我们会打开IDLE，会保存.py，也会按F5让代码跑起来。今天我们继续让电脑变聪明：不只是照着print说固定的话，还能把同学输入的名字先记住，再说出来。",
        check: "孩子能说出：IDLE负责写和运行代码，print负责显示内容。"
      },
      {
        when: "讲变量",
        title: "盒子比喻",
    ...
    demoSlides: [
      {
        kicker: "复习",
        title: "代码已经能跑起来",
        body: "我们已经会在IDLE里写代码、保存.py、按F5运行。现在先复习print。",
        code: "print(\"Hello\")",
        prompt: "这行代码会让电脑说什么？",
        teacherNote: [
          {
