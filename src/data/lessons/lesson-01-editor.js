    ...
    lessonFlow: [
      {
        time: "0-5分钟",
        phase: "复习：代码要写在哪里",
        teacher: "先复习第0课的 print(\"Hello, World!\")，再问：如果离开网页编辑器，真实电脑里在哪里写Python？",
        student: "回答需要一个写代码的地方，知道今天要认识Python和IDLE。"
      },
      {
        time: "5-12分钟",
      ...
      },
      {
        time: "40-45分钟",
        phase: "收口：五步口诀",
        teacher: "带孩子复述：安装Python、打开IDLE、新建文件、保存.py、F5运行。",
        student: "完成口头复述，再做练习。"
      }
    ],
    teacherScript: [
      {
        when: "开场",
        title: "为什么要讲编辑器",
        say: "上节课我们在网页里写了第一行代码。真正学习Python时，我们还要认识电脑里的写代码工具。今天我们就学习怎么打开Python的小本子：IDLE。",
    ...
    demoSlides: [
      {
        kicker: "复习",
        title: "代码要写在哪里？",
        body: "上节课我们让电脑说话。今天要认识真正写Python的小本子。",
        ...
        teacherNote: [
          {
            ...
            lines: [
              ...
              "但是程序员不可能只听老师讲，也不可能只看代码。今天我们要打开真正写代码的工具。"
            ]
          },
          {
            title: "过渡",
            lines: [
              "告诉孩子：今天的目标不是背安装步骤，而是会打开IDLE、会新建文件、会运行自己的代码。"
            ]
          }
        ],
        check: "孩子知道今天要亲手写代码。"
